...
from apps.core.api.views import SearchCarsAPIView, DataHistoryAPIView, PotentialFranchiseAPIView, ContactAPIView
...
urlpatterns = [
    ...
    path('write_contact/', ContactAPIView.as_view(), name='write_contact'),
